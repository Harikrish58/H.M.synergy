    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "H&M Synergy — Робота та рекрутинг у Польщі",
      },
    ],
  },
      ...
      >
        <div className="mx-auto grid max-w-[1280px] gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.72fr_1fr] lg:gap-20 lg:px-8 lg:py-28">
          ...
          <div>
            ...
            <Link href="/ua/about" className={`${textLink} mt-8`}>
              {content.company.cta}
      ...
      >
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="mt-5 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <Link href="/ua/services" className={`${textLink} shrink-0`}>
        ...
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="mt-6 grid gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20">
            <div>
              ...
              <Link href="/ua/employers" className={`${primaryLink} mt-8`}>
