...
export const metadata: Metadata = {
  title: "Apply – Injection Machine Operator | H&M Synergy",
  description:
    "Apply for the Injection Machine Operator position in Wrocław, Poland.",
};
        ...
        <div className="mt-8 overflow-hidden rounded-3xl border border-[#DCE4EB] bg-white shadow-sm">
          ...
          <div className="border-t border-[#DCE4EB] px-6 py-6 sm:px-8">
            ...
            <p className="mt-3 leading-7 text-[#5B6878]">
              We are looking for an Injection Machine Operator to work in
              Wrocław. The position involves operating injection moulding
              machines and carrying out production-related tasks according to
              company procedures.
            </p>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              <div>
                ...
                <span className="text-[#5B6878]">Full-time</span>
              </div>
              ...
              <div>
                ...
                <span className="text-[#5B6878]">{job.location.en}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-2xl leading-7 text-[#5B6878]">
              Complete the form below and upload your CV. Our recruitment team
              will review your application and contact you if your profile
