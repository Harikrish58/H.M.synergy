...
export const homeContent: Record<"en" | "pl" | "ua", HomeContent> = {
  en: {
    seo: {
  ...
  ua: {
    seo: {
      title: "Робота та рекрутинг у Польщі | H&M Synergy",

      description:
        "H&M Synergy – це агентство з працевлаштування та рекрутингу в Польщі, яке з'єднує роботодавців із працівниками та допомагає студентам, випускникам і працівникам з України знаходити роботу на виробництві, в логістиці та інших галузях.",
      ...
      keywords: [
        ...
        "вакансії для українців Польща",
        "тимчасова робота Польща",
      ],

      ogTitle: "H&M Synergy | Робота та рекрутинг у Польщі",

      ogDescription:
        "Знайдіть роботу в Польщі або надійних працівників для вашого бізнесу. H&M Synergy підтримує роботодавців і шукачів роботи у сферах виробництва, промисловості, логістики та інших секторах.",
    },

    hero: {
      eyebrow: "Рішення з працевлаштування та підбору персоналу в Польщі",

      title: "Поєднуємо потрібних людей із відповідними можливостями.",

      description:
        "H&M Synergy – це агентство з працевлаштування та рекрутингу в Польщі, яке об'єднує роботодавців з надійними працівниками та допомагає кандидатам знайти підходящу роботу. Ми спеціалізуємося на виробництві, промисловості, логістиці, складах та інших операційних посадах.",

      employerCta: "Знайти працівників",

      employeeCta: "Знайти роботу",
      ...
      imageDescription:
        "Рішення з працевлаштування та рекрутингу, що об'єднують людей та бізнес у Польщі.",
    },

    company: {
      eyebrow: "H&M Synergy",

      title: "Люди для бізнесу. Можливості для людей.",

      description:
        "Ми з'єднуємо компанії в Польщі з працівниками, які відповідають їхнім операційним потребам, і водночас допомагаємо шукачам знайти підходящу роботу. Від рекрутингу та підбору персоналу до координації співпраці – ми підтримуємо обидві сторони процесу працевлаштування.",
    ...
    services: {
      ...
      title: "Рекрутинг і кадрові рішення, побудовані навколо вашого бізнесу.",

      description:
        "Ми допомагаємо роботодавцям знаходити та координувати працівників для виробництва, промисловості, логістики, складів та інших операційних середовищ.",
      ...
      items: [
        {
          ...
          description:
            "Ми допомагаємо бізнесу знаходити працівників для виробництва, промисловості, складів, логістики та інших операційних посад відповідно до їхніх кадрових потреб.",
        },

        {
          ...
          description:
            "Ми шукаємо кандидатів і підбираємо їм відповідні посади, враховуючи вимоги роботодавця, робочого місця та конкретної ролі.",
        },

        {
          ...
          description:
            "Ми підтримуємо комунікацію та координацію протягом усього процесу працевлаштування, допомагаючи роботодавцям і працівникам залишатися на зв'язку під час співпраці.",
        },
      ],
    },

    manufacturing: {
      eyebrow: "Виробництво та промисловість",

      title: "Підтримка людей, які стоять за сучасним виробництвом.",

      description:
        "Виробництво та промисловість – ключові напрямки нашої рекрутингової діяльності. Ми допомагаємо роботодавцям знаходити працівників для роботи на термопластавтоматах, виробничих лініях, збірці та інших промислових посадах.",
      ...
      cta: "Переглянути доступні вакансії",
    },

    employers: {
      eyebrow: "Для роботодавців",

      title: "Потрібні надійні працівники для вашого підприємства?",

      description:
        "Розкажіть нам про ваші кадрові потреби, посади, які потрібно закрити, і коли вам потрібні люди. Ми разом з вами підберемо відповідне рішення з рекрутингу та персоналу.",

      steps: [
        "Розкажіть про ваші потреби",
        "Ми шукаємо підходящих кандидатів",
        "Ми підтримуємо процес працевлаштування",
      ],
    ...
    employees: {
      eyebrow: "Для шукачів роботи",

      title: "Знайдіть свою наступну роботу в Польщі.",

      description:
        "Відкрийте для себе можливості працевлаштування на виробництві, в промисловості, логістиці, на складах та в інших секторах. Студенти, випускники та працівники з України в Польщі завжди вітаються для подачі заявок на відповідні вакансії.",

      audience: [
        "Студенти, які шукають роботу в Польщі",
        "Випускники, що починають свою кар'єру",
        "Працівники з України, які шукають роботу в Польщі",
        "Кандидати, зацікавлені в роботі на виробництві та в промисловості",
      ],

      jobsCta: "Переглянути вакансії",

      contactCta: "Зв'язатися з рекрутером",
    },

    jobs: {
      eyebrow: "Актуальні вакансії",

      title: "Знайдіть доступні вакансії в Польщі.",

      description:
        "Перегляньте наші поточні вакансії та знайдіть пропозиції роботи, що відповідають вашим навичкам, досвіду та доступності.",

      listings: [
        {
          title: "Оператор термопластавтомата",
          meta: "Виробництво · Промисловість · Польща",
          details: "Повна зайнятість · Змінна робота",
        },

        {
          title: "Працівник виробництва",
          meta: "Виробництво · Польща",
          details: "Повна зайнятість · Змінна робота",
        },
      ],
    ...
    why: {
      eyebrow: "Чому H&M Synergy",

      title: "Зрозумілий підхід до рекрутингу та працевлаштування.",

      items: [
        {
          title: "Розуміння ваших потреб",

          description:
            "Ми приділяємо час, щоб зрозуміти особливості посади, робочого місця, графіка та кадрових вимог перед пошуком кандидатів.",
        },

        {
          title: "Підбір кандидатів",

          description:
            "Ми шукаємо кандидатів, чиї навички, досвід та доступність відповідають вимогам конкретної посади.",
        },

        {
          title: "Підтримка протягом усього процесу",

          description:
            "Ми залишаємося на зв'язку, щоб підтримувати комунікацію та координацію між роботодавцями і працівниками під час процесу працевлаштування.",
        },

        {
          ...
          description:
            "Пряма і зрозуміла комунікація допомагає роботодавцям і кандидатам краще розуміти процес рекрутингу та наступні кроки.",
        },
      ],
    },

    finalCta: {
      title: "Давайте знайдемо правильне рішення.",

      description:
        "Незалежно від того, чи є ви роботодавцем, який шукає працівників, чи кандидатом, який шукає роботу в Польщі, H&M Synergy готові вам допомогти.",
