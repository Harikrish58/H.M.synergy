...
const offerItems = [
  {
    ...
    description:
      "Current opportunities across manufacturing, production, warehousing, logistics and other operational environments in Poland.",
  },
  {
    title: "Recruitment Support",
    description:
      "Guidance throughout the application and recruitment process, from your first application to starting your new position.",
  },
  {
    title: "Employment Support",
    description:
      "Clear communication and practical support throughout your cooperation with H&M Synergy.",
  },
];
...
const steps = [
  ...
  "Our recruitment team contacts you",
  "Start your new job",
];
  ...
  return (
    <main className="overflow-hidden bg-white text-[#182230]">
        ...
        <div className="mx-auto max-w-[1280px] px-6 py-20 sm:px-10 lg:px-8 lg:py-28">
          <div className="max-w-4xl">
            ...
            >
              Find the right job.
              <br />
              Build your future in Poland.
            </h1>

            <p className={`mt-7 max-w-2xl ${bodyText}`}>
              H&M Synergy connects job seekers with employment opportunities
              across manufacturing, production, warehousing, logistics and
              other operational sectors in Poland.
            </p>
            ...
            <div className="mt-7 max-w-2xl border-l-2 border-[#159A86] pl-5">
              <p className="text-base font-semibold leading-7 text-[#0E2942] sm:text-lg">
                Students and graduates are welcome.
              </p>

              <p className="mt-1 text-sm leading-6 text-[#5B6878] sm:text-base">
                We welcome students, graduates, experienced workers and other
                job seekers looking for suitable employment opportunities in
                Poland.
              </p>
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.72fr_1fr] lg:gap-20">
            <div>
              ...
              <p className="mt-8 max-w-xs text-sm leading-6 text-[#8A96A3]">
                We help connect people with suitable employment opportunities
                and provide support throughout the recruitment process.
              </p>
            </div>
      ...
      >
        <div className="mx-auto grid max-w-[1280px] gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.72fr_1fr] lg:gap-20 lg:px-8 lg:py-28">
          <div>
            ...
            <p className="mt-8 max-w-xs text-sm leading-6 text-[#8A96A3]">
              We work with candidates at different stages of their careers and
              welcome people looking for their next opportunity in Poland.
            </p>
          </div>

          <div>
            <h2 id="candidate-groups-title" className={sectionTitle}>
              Opportunities for students, graduates and job seekers.
            </h2>

            <p className={`mt-6 max-w-2xl ${bodyText}`}>
              Whether you are starting your career, looking for your first
              job in Poland or already have professional experience, our
              available vacancies may include opportunities that match your
      ...
      >
        <div className="mx-auto grid max-w-[1280px] gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.72fr_1fr] lg:gap-20 lg:px-8 lg:py-28">
          <div>
            <p className={sectionLabel}>Types of Opportunities</p>
            ...
            <p className="mt-8 max-w-xs text-sm leading-6 text-[#8A96A3]">
              Available vacancies vary depending on employer requirements and
          ...
          <div>
            ...
            <p className={`mt-6 max-w-2xl ${bodyText}`}>
              We work with employers across different operational environments
              and recruit for a range of positions depending on current
              vacancies.
            </p>
            ...
            <Link href="/en/jobs" className={`${primaryLink} mt-8`}>
              Browse Jobs
        ...
        <div className="mx-auto max-w-[1280px] px-6 py-20 sm:px-10 lg:px-8 lg:py-28">
          <div className="max-w-3xl">
            ...
            <h2 id="process-title" className={`mt-5 ${sectionTitle}`}>
              A straightforward path to your next job.
            </h2>

            <p className={`mt-6 max-w-2xl ${bodyText}`}>
              We keep the application process clear and provide support as you
              move through the recruitment stages.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[1280px] flex-col gap-8 px-6 py-16 sm:px-10 md:flex-row md:items-end md:justify-between lg:px-8 lg:py-20">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-[#5B6878]">
              Explore available jobs and find an opportunity that matches your
              skills, experience and availability.
            </p>
          </div>

          <Link href="/en/jobs" className={`${primaryLink} shrink-0`}>
            View Available Jobs
      ...
      >
        <div className="mx-auto flex max-w-[1280px] flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div>
            <p className={sectionLabel}>Have Questions?</p>

            <h2
              id="contact-cta-title"
              className="mt-5 max-w-2xl text-3xl font-bold leading-tight tracking-[-0.035em] text-[#0E2942] sm:text-4xl"
            >
              Our recruitment team is ready to help.
            </h2>

            <p className="mt-5 max-w-xl text-base leading-7 text-[#5B6878] sm:text-lg sm:leading-8">
              If you have questions about a vacancy, the application process
              or opportunities for students, graduates or experienced workers,
